...
export const metadata: Metadata = {
  title: 'AILab',
  description: 'AI・ChatGPT活用情報',
  openGraph: { title: 'AILab', description: 'AI・ChatGPT活用情報', type: 'website', locale: 'ja_JP', siteName: 'AILab' },
  twitter: { card: 'summary_large_image', title: 'AILab', description: 'AI・ChatGPT活用情報' },
  ...
  return (
    <html lang="ja">
      <head>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{__html:`{"@context": "https://schema.org", "@type": "WebSite", "name": "AILab", "description": "AI・ChatGPT活用情報", "url": "https://ai-lab-jp.vercel.app", "publisher": {"@type": "Organization", "name": "AOKAE合同会社"}}`}} />
      </head>
      <body>{children}
